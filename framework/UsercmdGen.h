...
const int IMPULSE_23			= 23;			// EDEL : print player position
const int IMPULSE_24			= 24;			// EDEL : spawn berserker
const int IMPULSE_25			= 25;			// EDEL : pop up help menu
const int IMPULSE_26			= 26;			// EDEL : pop up buy menu
